...
export default function CustomerSupport() {
  ...
  async function getSupport() {
    await fetch(`http://localhost:5000/getSupport`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/reply", Data, {
        headers: {
              ...
              <tbody id="tablebody">
                {data.map((item, index) => (
                  <tr class="border-b">
                    ...
                    <td class="px-6 py-4">
                      {item.replied == 1 ? "Replied" : "Not Replied"}
                    </td>
                    <td class="px-6 py-4">
                      <a
                        href="#"
        ...
        <MDBModalDialog style={{ borderRadius: 0 }}>
          <MDBModalContent id="card">
            ...
            >
              ...
              >
                {submit ? <MDBSpinner color="info" /> : <span>Send</span>}
              </MDBBtn>
              {/* </MDBModalFooter> */}
            </form>
          </MDBModalContent>
